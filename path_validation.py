...
def main(delete=0, n_files=15):
    ...
    path1 = '/Volumes/Extreme_SSD/FE_block2_060000_retracks_final/FE_block2_060000_%s_final'
    path2 = '/Volumes/Extreme_SSD/FE_block2_060000_retracks_final/FE_block2_060000_%s_final'
