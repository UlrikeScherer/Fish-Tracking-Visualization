...
path_csv_feeding_local="$root_local/FE_tracks_original/FE_tracks_${FEEDINGTIME}/FE_tracks_${FEEDINGTIME}_$BLOCK/FE_${FEEDINGTIME}_tracks_${BLOCK}"
dir_feeding_front="${path_csv_feeding_local}_front"
dir_feeding_back="${path_csv_feeding_local}_bacck"
