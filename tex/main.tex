...
\newcommand{\feedinglegend}{
    \begin{center}
        ...
        \begin{tabular}{p{3cm} p{7cm} }
            ...
            Considered Feeding Time & is the time corresponding to the number of data frames in the scope of the feeding window. Data frames outside of the feeding window are not counted as feeding time, however they might be inside the box. The Feeding Window mostly from 14:05 to 16:10.  
            \end{tabular}
    \end{center}
}
