...
\begin{subfigure}[h]{\subfigwidth}
    \includegraphics[width=\textwidth, height=.24\textheight]{\camera/#1/#2.pdf}
...
\newcommand{\trajectorylegend}{
    \begin{center}
        ...
        \begin{tabular}{p{1cm} p{7cm} }
            ...
            $\# misses $ & the number of misses in the csv-batch, such as invalid data frames outside of the tank and non values. \\
...
\newcommand{\feedinglegend}{
    \begin{center}
        ...
        \begin{tabular}{p{3cm} p{7cm} }
            ...
            \# Visits & is the number of times the individual entered the illustrated box around the feeding patch. 
            \end{tabular}
    \end{center}
}
