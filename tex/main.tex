...
\newcommand{\rootserver}{smb://141.20.65.49/data/loopbio_data/1_FE_(fingerprint_experiment)_SepDec2021/FE_block1/}
\newcommand{\rootrecord}{smb://141.20.65.49/data/loopbio_data/1_FE_(fingerprint_experiment)_SepDec2021/FE_block1/FE_block1_recordings/FE_block1_recordings_week1/}
\def \RawURL{\rootdir\camera/}

\title{Developing exploration behavior\\
Trajectory over time of the molly at camera: \href{\rootdir\camera/}{\camera}{} and position: \position\\
    %\rootdir \posstr
}
...
\newcommand{\firstbox}[1]{
    \fbox{\parbox[c][3cm]{0.22\textwidth}{\StrMid{#1}{0}{4}/\StrMid{#1}{5}{6}/\StrMid{#1}{7}{8}{} at \StrMid{#1}{10}{11}:\StrMid{#1}{12}{13}\\
     ...
     Video: \\
     CSV: \url{\rootdir\camera/#1.\camera/}
     }}
}
