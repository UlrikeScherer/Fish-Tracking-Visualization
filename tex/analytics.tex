...
\begin{figure}[!hb]
    \foreach \i in {100_activity,100_tortuosity,100_turning_angle,200_entropy, 100_wall_distance} {
            \subf{\i_\position#1}
            %\vskip\baselineskip
    }
    \label{fig: #1}
...
\begin{tabular}{p{3cm} p{8cm} }
    ...
    \textbf{Wall Distance} & is the distance to the nearest wall in average for every 100 seconds. 
\end{tabular}
\begin{tabular}{llll}
