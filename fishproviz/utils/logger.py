...
def create_logger(
    ...
    log_stream_handler = create_log_stream_handler(log_level_stream, formatter)

    logger.filepath = create_filepath_with_timestamp(logger_name)
    log_file_handler = create_log_file_handler(
        logger.filepath, log_level_file, formatter
    )
...
def create_log_stream_handler(log_level_stream: int, formatter):
...
def create_log_file_handler(filename: str, log_level_file: int, formatter):
